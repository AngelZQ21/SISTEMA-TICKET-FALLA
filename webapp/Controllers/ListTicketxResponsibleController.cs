...
{
    public class ListTicketxResponsibleController : Controller
    {
        ...
        public ActionResult VlistTicketxResponsible()
        {
            try
            {
                ...
                string Valicacion = new BL_Menu().ValidarMenuPerfilActual(Convert.ToInt32(usuario[2]), "ListTicketxResponsible", "VlistTicketxResponsible");

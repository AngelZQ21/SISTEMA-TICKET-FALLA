...
{
    public class ChangeStatusTicketActivityController : Controller
    {
        ...
        public ActionResult VchangeStatusTicketActivity()
        {
            try
            {
                ...
                string Valicacion = new BL_Menu().ValidarMenuPerfilActual(Convert.ToInt32(usuario[2]), "ChangeStatusTicketActivity", "VchangeStatusTicketActivity");

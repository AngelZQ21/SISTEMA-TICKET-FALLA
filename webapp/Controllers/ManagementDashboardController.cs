...
namespace SmartAdminMvc.Controllers
{
    public class ManagementDashboardController : Controller
    {
        ...
        public ActionResult VmanagementDashboard()
        {
            try
            {
                ...
                string Valicacion = new BL_Menu().ValidarMenuPerfilActual(Convert.ToInt32(usuario[2]), "ManagementDashboard", "VmanagementDashboard");
